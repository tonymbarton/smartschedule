...
print(providernametoid)
print(providerslastname)
...
appt = (open_appts['appointments'])

for x in appt:
    appt_date = str(x['date'])
    appt_starttime = str(x['starttime'])
    appt_duration = str(x['duration'])
    print(appt_date + " " + appt_starttime + " " + appt_duration)
